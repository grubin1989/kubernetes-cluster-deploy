...
KUBE_POD_ARGS="--pod-eviction-timeout=0s"
KUBE_NODE_ARGS="--node-monitor-grace-period=30s"
EOF
...
ExecStart=/opt/kubernetes/bin/controller-manager ${KUBE_CONTROLLER_MANAGER_OPTS}
Restart=on-failure
